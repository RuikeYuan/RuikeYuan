...
- ✨ I am deeply passionate about **algorithms and theories related to Go (board game)**,  
  including **game theory and graph theory** — stay tuned!

- 🔭 I am also exploring **practical applications in hardware**,  
  as well as **robotics and embedded systems development**

- 🎯 Hobbies: **chess, Go, VRChat, football, swimming**

- 🎓 I completed my preparatory year at  
  **[NHL Stenden University of Applied Sciences](https://www.nhlstenden.com/en)**

- 🎓 Currently a **Data Science and Artificial Intelligence** student at  
  **[Leiden University](https://www.universiteitleiden.nl/en)**

- 👨‍💻 Previously a **Full Stack Developer (mainly backend)** at  
...
_Mar 2024 – Mar 2025 · The Hague, Netherlands_

Worked on backend solutions using **TypeScript**, **Postman APIs**, and **cloud services**,  
with a focus on **scalable architecture** and **API efficiency**.

Very grateful for the guidance and support from my boss and colleagues 🙏
...
- **[Metal & Gold Trading Platform](https://github.com/RuikeYuan/Crypto-And-Metal-Trading-Platform)** (2024)  
  Secure web platform with real-time pricing and analytics

- **[3D Printer DIY Arduino](https://github.com/RuikeYuan/3D-Printer-DIY-Arduino)** (2017)  
  Custom-built 3D printer using Arduino + Marlin firmware
